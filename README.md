...
being passed into the engine. Terms can either be strings, or integers (pre-mapped). If you want to
pre-map your query terms, use the binary in the `format_queries` directory.  
