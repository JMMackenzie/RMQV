...
namespace ds2i {
    ...
    private:
        ...
        {
            fillvar("DS2I_K", k, 10);
            fillvar("DS2I_BLOCK_SIZE", block_size, 64); 
            ...
            fillvar("DS2I_FIXED_COST_WAND_PARTITION", fixed_cost_wand_partition, 17.5); // VBMW 
            fillvar("DS2I_EPS1_WAND", eps1_wand, 0.01); 
            fillvar("DS2I_EPS2_WAND", eps2_wand, 0.4); //VBMW
            fillvar("DS2I_SCORE_REFERENCES_SIZE", reference_size, 128); //VBMW
